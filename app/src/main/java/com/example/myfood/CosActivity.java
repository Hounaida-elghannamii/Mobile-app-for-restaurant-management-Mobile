...
public class CosActivity extends AppCompatActivity {
    ...
    private void recPopolur() {
        ...
        foodDS.add(new FoodD("Poulet","xyxy","Le couscous est d'une part une semoule de blé dur préparée à l'huile d'olive et d'autre part, une spécialité culinaire issue de la cuisine berbère, à base de couscous, de légumes, d'épices, d'huile d'olive et de poulet ",6.0,4,25,300));
